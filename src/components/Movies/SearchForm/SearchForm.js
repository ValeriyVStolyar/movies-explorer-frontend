...
function SeachForm(props) {
  ...
  // const seachSavedMoviesValue = JSON.parse(localStorage.getItem('seachsaved')) || '';
  const seachSavedMoviesValue = '';
  const { pathname } = useLocation();
  const seachMovies = pathname === '/movies' ? seachMoviesValue : seachSavedMoviesValue;
  // const seachMovieValue = JSON.parse(localStorage.getItem('seach'));
  // const [keyLetters, setKeyLetters] = React.useState(JSON.parse(localStorage.getItem('seach')));
  ...
  function handleSeachMovieNames(e) {
    ...
    // localStorage.setItem('seach', JSON.stringify(e.target.value));
    // setKeyLetters(localStorage.setItem('seach', JSON.stringify(e.target.value)));
    // console.log(JSON.parse(localStorage.getItem('seach')))
    // setKeyLetters(JSON.parse(localStorage.getItem('seach')))
  }
  ...
  function handleSubmit(e) {
    ...
    // seachMovie(JSON.parse(localStorage.getItem('seach')));
    // setKeyLetters(JSON.parse(localStorage.getItem('seach')));
